This is a script that was used during the Google IT Automation course that converted a CSV file fed into it to a HTML page. I did not have to edit/manipulate this script. This is here, so that I may refer back to it later for future projects.
